...
<head>
    ...
    <meta charset="utf-8" />
    <title>Ilaro de respondeculoj | Esperanto centroj</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="esperanto" name="description" />
    <meta content="Esperanto centroj" name="author" />
...
<div id="wrapper">
        ...
        <div class="container-fluid">
            <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <form class="app-search">
                        <div class="app-search-box dropdown">
                            <div class="input-group">
                                <input readonly type="search" class="form-control disabled" placeholder="Serĉu..." id="top-search">
                ...
                <li class="dropdown d-inline-block d-lg-none">
                    ...
                    <div class="dropdown-menu dropdown-lg dropdown-menu-end p-0">
                        <form class="p-3">
                            <input  type="text" class="form-control disabled" placeholder="Serĉu ..." aria-label="Recipient's username">
                        </form>
                    </div>
                </li>
                ...
                <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                    <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{asset('asset/img/600px-Flag_of_Esperanto.svg.png')}}" alt="user-image" height="16">
                    </a>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{asset('asset/img/149071.png')}}" alt="user-image" class="rounded-circle">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                        ...
                        <div class="dropdown-header noti-title">
                            <h6 class="text-overflow m-0">Bonvenon !</h6>
                        </div>
                ...
                <li class="dropdown notification-list">
                    <a href="javascript:void(0);" class="nav-link right-bar-toggle waves-effect waves-light">
                        <i class="fa fa-settings noti-icon"></i>
                    </a>
                </li>
            ...
            <div class="logo-box">
                <a href="/" class="logo logo-dark text-center">
                            <span class="logo-sm">
                                <img src="{{asset('assets-admin/images/logo-dash.png')}}" alt="" height="50">
                                <!-- <span class="logo-lg-text-light">UBold</span> -->
                            </span>
                    <span class="logo-lg">
                                <img src="{{asset('asset/img/logo-dash.png')}}" alt="" height="50">
                ...
                <a href="/" class="logo logo-light text-center">
                            <span class="logo-sm">
                                <img src="{{asset('asset/img/logo-dash.png')}}" alt="" height="52">
                            </span>
                    <span class="logo-lg">
                                <img src="{{asset('asset/img/logo-dash.png')}}" alt="" height="50">
                            </span>
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li class="dropdown d-none d-xl-block">
                    ...
                    <div class="dropdown-menu">
                        <!-- item-->
                        <a href="/aldoni" class="dropdown-item">
                            <i class="fa fa-users me-1"></i>
                            <span>Respondesculo</span>
                        </a>

                        <!-- item-->
                        <a href="/eventoj" class="dropdown-item">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div id="sidebar-menu">
                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="{{route('miaj-videoj')}}">
                            <i data-feather="video"></i>
                            <span> Miaj videoj </span>
                        </a>
                    </li>


                    <li>
                        <a href="{{route('eventoj')}}" >
                            <i data-feather="users"></i>
                            <span>Enretigi eventoj</span>
                    ...
                    <li>
                        <a href="{{route('anoncoj')}}" >
                            <i data-feather="mail"></i>
                            <span>Enretigi anoncoj</span>
                            <span class="menu-arrow"></span>
                        </a>
                    ...
                    <li>
                        <a href="{{route('aldoni')}}">
                            <span class="badge bg-pink float-end"></span>
                            <i data-feather="plus"></i>
                            <span> Aldoni Estrarano </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('agadoj')}}">
                            ...
                            <span> Lastaj aldonoj </span>
                        </a>
                    </li>

                    <li>
                        <a onclick="alertlogout()" href="/logout" >
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <script>document.write(new Date().getFullYear())</script> &copy; Esperanto-centroj <a href="#"></a>
                </div>
                <div class="col-md-6">
            ...
            <div class="tab-pane" id="chat-tab" role="tabpanel">
                ...
                <form class="search-bar p-3">
                    <div class="position-relative">
                        <input type="text" class="form-control disabled" placeholder="Serĉu...">
            ...
            <div class="tab-pane active" id="settings-tab" role="tabpanel">
                ...
                <div class="p-3">
                    ...
                    <div class="d-grid mt-4">
                        ...
                        <a href="../../../../external.html?link=https://1.envato.market/uboldadmin" class="btn btn-danger mt-3" target="_blank"><i class="mdi mdi-basket me-1"></i> Purchase Now</a>
                    </div>
...
<!-- Init js-->
<script src="{{asset('assets-admin/js/pages/form-quilljs.init.js')}}"></script>
...
<script>
    $('.quill-editor1').each(function(i, el) {
        var el = $(this), id = 'quilleditor-' + i, val = el.val(), editor_height = 200;
        var div = $('<div/>').attr('id', id).css('height', editor_height + 'px').html(val);
        el.addClass('d-none');
        el.parent().append(div);
        ...
        $(document).ready(function () {
            ...
            $('#fileUploadForm').ajaxForm({
                ...
                uploadProgress: function (event, position, total, percentComplete) {
                    ...
                    //if 100% then show the success message and change progress bar color to green

                    if (percentage == 100) {
                       //if 100% progress bar to bg-success
                        $('.progress .progress-bar').removeClass('bg-danger').addClass('bg-success');
                        $('.progress .progress-bar').css("width", percentage+'%', function() {
                            return $(this).attr("aria-valuenow", percentage) + "%";
                        })
                        $('.progress .progress-bar').html('Kompletigita');

                    }
                },
                complete: function (xhr) {

                    //show success message  toasts
...
<script>
    // sweet alert for alertlogout() function
    function alertlogout() {
        swal({
            title: "Jeni i sigurt?",
            text: "Deshironi te dilni nga llogaria!",
            type: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn-danger",
            confirmButtonText: "Po, dil!",
        ...
        function(isConfirm) {
            if (isConfirm) {
                swal("Dilur!", "Dilur nga llogaria.", "success");
                window.location.href = "{{ route('logout') }}";
            } else {
                swal("Anuluar", "Anuluar :)", "error");
            }
        });
    }
</script>
