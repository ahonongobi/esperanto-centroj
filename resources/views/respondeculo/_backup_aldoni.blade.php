...
<section  class="no-padding-top">
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-10">
        <div class="block">
          <div class="title"><strong class="d-block">Aldoni</strong><span class="d-block">Aldoni aliajn respondeculojn (maksimume tri)</span></div>
          ...
          <form method="POST" action="{{route('membroj')}}" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form-group">       
                ...
                <input type="text" name="surname" placeholder="Indidua nomo" class="form-control">
