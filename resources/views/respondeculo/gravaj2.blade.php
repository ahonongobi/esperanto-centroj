                        ...
                        <div class="container">
                            <form method="POST" action="{{route('informoj')}}">
                                ...
                                <div class="form-group col-sm-9">
                                    ...
                                    <input type="text" name="name" placeholder="Nomo " value="{{$centroInformoj[0]->name}}" class="form-control">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-sm-9">
                                    ...
                                    <input type="text" name="lieu" value="{{$centroInformoj[0]->lokejo}}" placeholder="Situo, kiel atingi la centro ?" class="form-control">
                                    @if($errors->has('lieu'))
                                ...
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    <input type="text" name="Telefono" value="{{$centroInformoj[0]->Telefono}}" placeholder="Telefono" class="form-control">
                                ...
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    <input type="text" name="trajto" value="{{$centroInformoj[0]->trajto}}" placeholder="Specifaj trajtoj" class="form-control">
                                ...
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    <input type="text" name="agado" value="{{$centroInformoj[0]->agado}}" placeholder="Agadplano(j)" class="form-control">
                                    @if($errors->has('agado'))
                                        <p style="color: green;" class="text-red">{{ $errors->first('agado') }}</p>
                                    @endif
                                </div>
                                <div class="form-group col-sm-9 mt-3">
                                    <label class="form-control-label">Stratadreso:</label>
                                    <input type="text" name="Kontaktadreso" value="{{$centroInformoj[0]->Kontaktadreso}}" placeholder="Kontaktadreso" class="form-control">
                                ...
                                <div class="form-group col-sm-9 mt-3">
                                    ...
                                    <input type="text" name="retejo" value="{{$centroInformoj[0]->retejo}}" placeholder="Propa retejo " class="form-control">
                                ...
                                <div class="mt-3">
                                    ...
                                    <button type="submit" style="background-color:;" class="btn btn-primary"><i class="fa fa-edit"></i>Modfifi</button>
