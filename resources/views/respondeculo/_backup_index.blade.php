        ...
        <p>{{substr($post->desc,0,60)."..."}}</p>
          ...
          <div>
            <div class="d-flex ml-3">
              <a  onclick="return confirm('Chu vi certas?')" href="{{url('delete2'.'/'.$post->id)}}" class="btn btn-secondary mt-2 mr-2" style="margin-left:1px;"><i style="color: #e95f71;font-size:20px;" class="fa fa-trash"></i>forigi</a>
        ...
        <div class="title"> <strong class="d-block">{{$UseVideo->title}}</strong><span class="d-block">{{$UseVideo->desc}}</span></div>
          ...
          Your browser does not support the video tag.
            ...
            <div class="d-flex ml-3">
              ...
              <a onclick="alerte2()"  class="btn btn-warning mt-2 text-white" style="margin-left:1px;"><i style="color: red" class="fa fa-edit"></i>Modifii</a>
            </div>
