...
<head>
   ...
   /** on mobile device style="margin-right: 10% !important;" */
    ...
    <div class="auth-fluid-form-box">
        <div class="align-items-center ml-md-4 d-flex h-100">
            <div class="p-3">
                ...
                <!-- title-->
                <h4 class="mt-0">Registriĝu nun</h4>
                ...
                <form action="{{route('register')}}" method="post">
                    ...
                    <div class="mb-3">
                        <label for="emailaddress" class="form-label">
                            Via nomo</label>
                        <input class="form-control" type="text" name="name" id="emailaddress" required="" placeholder="Via nomo">
                        @if($errors->has('name'))
                    ...
                    <div class="text-center d-grid">
                        <button style="background-color: green !important;" class="btn btn-success" type="submit">Aliĝu</button>
                    </div>
                    <!-- social-->
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Ĉu vi havas konton?  <a href="/logon" class="text-muted ms-1"><b>Ensalutu</b></a></p>
                </footer>
