...
<head>
	...
	<!-- Meta tag Keywords -->
	<!-- css files -->
	<link rel="stylesheet" href="{{asset('assets/css/loginCss.css')}}" type="text/css" media="all" />
	<!-- Style-CSS -->
...
<body>
	...
	<form action="{{route('login')}}" method="post">
		@csrf
            ...
            <input placeholder="Retpoŝto" value="{{$email}}" name="email" type="email">
				@if($errors->has('email'))
			...
			<div class="form-style-agile">
				...
				<input placeholder="Pasvorto"  value="{{$pass}}" name="password" type="password" >
