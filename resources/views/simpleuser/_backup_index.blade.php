	...
	<div class="container p-md-5">
		<div class="about-hny-info text-left px-md-5">
			...
			<p class="sub-tittle mt-3 mb-4">Tiu retejo prezentas la Esperanto-centrojn en la tuta mondo. Ĝi estas starigita de
				...
				ILEI kune. Ĝi ebligas ekkoni ĉiujn centrojn, iliajn agadojn, ofertojn, ecojn.<br>Esperanto-centro estas iu strukturo, kiu organizas eventojn en – per – por Esperanto aŭ kie konserviĝas kolektoj de esperantaĵoj.
				<br>La respondeculoj de la Esperanto-Centroj ensalutu ĉi-tie:</p>
						...
						<div class="maghny-grid">
							<figure class="effect-lily">
								...
								<figcaption class="w3set-hny">
									<div>
										<h4 style="text-transform: none;" class="top-text">{{$picture->description1}}
			...
			<div class="blog-inner-grids py-md-4 row">
				<div class="mag-content-left-hny col-lg-8">
					...
					<div class="mag-hny-content">
						<h3 class="hny-title">Lastaj <span>Agadprogramoj</span></h3>
						<!--/mag-left-grid-1-->
							...
							<div class="maghny-gd-1 col-lg-4 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										...
										<figcaption>
											<div>
												<h4 style="text-transform: none;">{{$agado->title}} <span>{{$agado->center}}</span></h4>
								...
								<h5><a style="text-transform: none;" href="#">
									{{$agado->desc}}</a></h5>
								...
								class="meta-author"><span>Enretigi&nbsp;</span><a href="#" class="author-name">{{$agado->center}}</a> </span>
					...
					<div class="mag-hny-content my-lg-5 mb-5">
						<h3 class="hny-title">Listoj de <span>Agadprogramoj</span></h3>
						...
						<div class="maghny-grids-inf row  mt-3">
							...
							<div class="mag-post-fashion-details col-md-6 mt-md-0 mt-4">
								<a href="#" class="link-mag">
									<h4 style="text-transform: none;" class="mag-post-head">
									{{$allagado->title}}</h4>
								</a>
								<div class="mag-post-meta mt-3"><a href="#"><img src="{{ asset('storage/actuality_photos/'.$allagado->logo)}}"
											class="img-fluid rounded-circle admin-img admin-img1" alt=""></a> <span
								class="meta-author"> <span>Enretigi&nbsp;</span><a href="#" class="author-name">{{$allagado->center}}</a> </span>
									<span class="author-date">{{date('d-m-Y', strtotime($allagado->created_at))}}</span>
								</div>
							<p style="text-transform: none;" class="para my-3">{{$allagado->desc}}</p>
					...
					<div class="mag-hny-content my-5">
						<h3 class="hny-title">ILEI <span> Eventoj:</span></h3>
						<!--/mag-left-grid-1-->
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
									<a href="#"><img class="img-fluid" src="{{asset('assets/images/slides/images/ileievento.jpeg')}}" alt=""></a>
								</div>
								<h5><a href="#">
						...
						<h3 class="hny-title">UEA<span> Eventoj:</span></h3>
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
								...
								<div class="grid-social-box col-lg-3 col-sm-6">
									<a href="#" class="sub-facebook"><span class="fa fa-facebook"
										...
										<div class="soc-info">
											...
											<span class="sub_social_info sub_social_info_name">ŝatantoj</span>
										</div>
					...
					<!--/mag-hny-content-4-->
					<div class="mag-hny-content my-lg-5">
						<h3 class="hny-title">bildoj <span>de ĉiuj centroj</span></h3>
						<!--  Demos -->
						<div id="demos">
				...
				<div class="mag-content-right-hny col-lg-4">
					<aside>
						<div class="side-bar-hny-recent mb-5">
							...
							<div class="mag-small-post">
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="assets/images/EO-muzeo_vieno afisho.JPG" class="img-fluid" alt=""></a>

									</div>
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Esperanto-museum, Aŭstrio</a> </h4>

										<div class="mag-post-meta"><span class="meta-author"><span>&nbsp;</span><a
													href="#" class="author-name">Vieno</a> </span>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="assets/images/Nacia_Esperanto_Muzeo_de_Gray_(Francio)_-_plato.jpg" class="img-fluid" alt=""></a>

									</div>
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Francio, <span style="text-transform: lowercase" >Musée national d'</span> Espéranto</a>
										</h4>

										<div class="mag-post-meta"><span class="meta-author"><span>&nbsp;</span><a
													href="#" class="author-name">Gray</a> </span>
											<span class="author-date"></span>
										</div>
									</div>
								</div>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="assets/images/The_Ludwik_Zamenhof_Center,_Białystok.JPG" class="img-fluid" alt=""></a>

									</div>
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Polando, Esperanto-centro</a> </h4>


										<div class="mag-post-meta"><span class="meta-author"><span>&nbsp;</span><a
													href="#" class="author-name">Bialistoko</a> </span>
											<span class="author-date"></span>
										</div>
									</div>
								</div>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="assets/images/Musée_Esperanto_Zaozhuang_Chine.jpg" class="img-fluid" alt=""></a>

									</div>
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Ĉinio, Zaozhuang</a>
										</h4>


										<div class="mag-post-meta"><span class="meta-author"><span>&nbsp;</span><a
													href="#" class="author-name">Esperanto-muzeo</a> </span>
											<span class="author-date"></span>
										</div>
									</div>
								</div>
					...
					<!--	<div class="side-bar-hny-recent mb-5">
						...
						<div class="side-bar-hny-recent mb-5"> 
							<h4 class="mag-side-title">Plej Popularaj<span> paĝoj </span></h4>
						...
						<div id="prini" class="side-bar-hny-recent mb-5">
							<h4 class="mag-side-title">Salutvortoj<span> de ILEI</span></h4>
							<div class="mag-small-post dont-miss-grids-inf">
								<div class="maghny-gd-1">
									
									<h5><a href="#">
										Salutvortoj de ILEI</a></h5>
									<p>ESPERANTO-CENTROJ	
										...
										Vivu multaj grandaj kaj fortaj EO-centroj en la tuta mondo ! <br>
										Mireille Grosjean
										Prezidanto de ILEI
										Kotonuo, Benino, 2020-12-15 <br>
										La retejo estas prizorgita de Gobi Parfait Abyssinie Ahonon, teknikaj aspektoj<a href="mailto:abyssiniea@gmail.com">(abyssiniea@gmail.com)</a> kaj Mireille Grosjean, enhavaj aspektoj <a href="mailto:mirejo.mireille@gmail.com">(mirejo.mireille@gmail.com).</a> 
									</p>
				...
				<hr>
				<section style="font-style: italic; color:green;" class="sek1" data-nombro="9" id="montrinovajhojn">
					<h4>Laste ŝanĝita: 14 Novembro 2020 (13:08)</h4>
					<h4>URL: <a href="https://esperanto-centroj.info">https://esperanto-centroj.info</a> </h4>
					<h4>Retpoŝto: abyssiniea@gmail.com</h4>
					<h6>&copy; Ĉi tiu verko estas disponebla laŭ la permesilo</h6>
				</section>
			</div>
