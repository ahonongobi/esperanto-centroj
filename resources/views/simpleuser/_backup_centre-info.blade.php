		...
		<div class="top_w3pvt_main container">
			...
			<div class="inner-w3pvt-page-info">
				<ol class="breadcrumb d-flex">
					...
					<li class="breadcrumb-item active">Centro-agadoj</li>
				</ol>
...
<section class="w3l-mag-main">
	...
	<div class="mag-content-inf py-5">
		...
		<div class="container">
			<h3 class="hny-title text-center">Malkovru <span> Eventojn</span></h3>
			...
			<ul>
				...
				<li class="booking-card" style="">
					...
					<div class="informations-container">
						<h2 class="title">Priskriboj pri la afiŝoj</h2>
				...
				<li class="booking-card" style="">
					...
					<path fill="currentColor" d="M3,6H21V18H3V6M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M7,8A2,2 0 0,1 5,10V14A2,2 0 0,1 7,16H17A2,2 0 0,1 19,14V10A2,2 0 0,1 17,8H7Z" />
					  ...
					  <path fill="currentColor" d="M19,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z" />
							...
							<p>{{date('d-m-Y',strtotime($gobi->created_at))}}</p>
						  </div>
						</div>
		   ...
		   <div class="row pagination d-flex justify-content-center">{!! $allpost->appends(Request::all())->links() !!}</div>
			...
			<div class="blog-inner-grids py-md-4">
				<div class="mag-content-left-hny">
					...
					<div class="container">
						<h3 class="hny-title"><span>Filmetoj</span></h3>
						@if($count3==0)
						<center><p>Ne havas novajn agadprogramojn</p></center>
					       @else
						<div class="row">
							...
							<div class="social-media-icons row">
								...
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color:yellow" href="#" class="sub-facebook twitter"><span class="fa fa-location-arrow"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">loko</span>
								...
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: #17a2b8" href="#" class="sub-facebook twitter"><span class="fa fa-book"
											aria-hidden="true"></span>
										<div class="soc-info">
								...
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: #f0f0f0" href="#" class="sub-facebook twitter"><span class="fa fa-window-maximize"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">Retpaĝo</span>
											<span class="sub_social_info sub_social_info_name">{{$infos[0]->retejo}}</span>
										</div>
									</a>
								</div>
								<div style="" class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: yellow" href="#" class="sub-facebook twitter"><span class="fa fa-bed"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">jaro de fondo</span>
								...
								<div class="grid-social-box col-lg-3 col-sm-112 mt-3">
									<a style="background-color: #17a2b8" href="#" class="sub-facebook twitter"><span class="fa fa-meetup"
											aria-hidden="true"></span>
										<div class="soc-info">
								...
								<div class="grid-social-box col-lg-3 col-sm-10 mt-3">
									<a style="background-color: #f0f0f0" href="#" class="sub-facebook twitter"><span class="fa fa-envelope"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">Retadreso de la Centro</span>
								...
								<div class="grid-social-box col-lg-3 col-sm-10 mt-3">
									<a style="background-color:yellow" href="#" class="sub-facebook twitter"><span class="fa fa-envelope"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">Stratadreso</span>
											<span class="sub_social_info sub_social_info_name">{{$infos[0]->Kontaktadreso}}</span>
										</div>
									</a>
								</div>
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: orange" href="#" class="sub-facebook twitter"><span class="fa fa-coffee"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">Manĝejo</span>
											<span class="sub_social_info sub_social_info_name">{{$infos[0]->mangheblo}}</span>
										</div>
									</a>
								</div>
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: #17a2b8" href="#" class="sub-facebook twitter"><span class="fa fa-thumbs-up"
											aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">{{$countLike}}</span>
								...
								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: yellow" href="#" class="sub-facebook twitter"><span class="fa fa-hacker-news"
										...
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">Jaro de fondo</span>
											<span class="sub_social_info sub_social_info_name">{{$infos[0]->jaro}}</span>
										</div>
									</a>
								</div>

								<div class="grid-social-box col-lg-3 col-sm-12 mt-3">
									<a style="background-color: orange" href="#" class="sub-facebook twitter"><span class="fa fa-bed"
											aria-hidden="true"></span>
										<div class="soc-info">
						...
						<div class="comment-wrapper">
							<div class="panel panel-info">
								...
								<input type="hidden" name="centre_id" value="{{$id}}">
									<textarea name="message" id="message" class="form-control" placeholder="skribu komenton" rows="3"></textarea>
									@if($errors->has('message'))
									<p style="color: red;" class="text-red">{{ $errors->first('message') }}</p>
							   @endif
								<br>
								<button  id="" class="btn btn-info pull-right">Sendu <i class="fa fa-send"></i></button>
