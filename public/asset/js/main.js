(function ($) {
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='/'><img src='http://localhost:8000/asset/img/logo_reduce.png' alt='logo' width='400' class='img-fluid'/></a></div>"
        });
    }
